    ...
    <div class="main-content">
        <div class="container">
            ...
            <div class="container-content">
                <form action="/<?= PROJECT_NAME ?>/admin/users/<?= $data[0]['user_id'] ?>" method="post">
                    <input type="hidden" name="_method" value="PUT">
                    <input type="hidden" name="user_id" value="<?php echo htmlspecialchars($data[0]['user_id']) ?>">
                    <input type="hidden" name="address_id" value="<?php echo htmlspecialchars($data[0]['address_id']) ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="gender-group">
                            <label>
                                ...
                                <?= ($data[0]['gender'] == 'male') ? 'checked' : '' ?>> Male
                            </label>
                            <label>
                                <input type="radio" name="gender" value="female"
                                <?= ($data[0]['gender'] == 'female') ? 'checked' : '' ?>> Female
                            </label>
                            <label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="street" name="street" value="<?php echo htmlspecialchars($data[0]['street']) ?>" placeholder="Street">
                    </div>

                    <div class="form-group">
                        <label for="city">City: </label>
                        <input type="text" id="city" name="city" value="<?php echo htmlspecialchars($data[0]['city']) ?>" placeholder="City">
                    </div>

                    <div class="form-group">
                        <label for="role">Role: </label>
                        <select name="role" id="role">
                            <option value="1" <?php echo htmlspecialchars($data[0]['role'] == App\Models\User::ROLE_USER ? 'selected' : '') ?>>Customer</option>
                            <option value="2" <?php echo htmlspecialchars($data[0]['role'] == App\Models\User::ROLE_STAFF ? 'selected' : '') ?>>Staff</option>
                            <option value="3" <?php echo htmlspecialchars($data[0]['role'] == App\Models\User::ROLE_ADMIN ? 'selected' : '') ?>>Admin</option>
                        </select>
                    </div>
